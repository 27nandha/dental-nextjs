  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-[1fr_1fr_1fr] grid-cols-1 md:gap-2 md:mt-[125px] border-y-[10px] border-dark mx-2">
        <div className="bg-[url(/lumineers.jpg)] bg-cover my-10"></div>
        ...
        <div className="left-section" id="what-are-lumineers">
          ...
          <div className="bg-dark p-5 mt-10 text-white">
            ...
            <div className="flex flex-col mb-4">
              ...
              <a className="text-justify font-tinos mt-3" href="#">
                Q.{" "}
                <span className="underline">How long do Lumineers last?</span>
              </a>
              <a className="text-justify font-tinos mt-3" href="#">
                Q. <span className="underline">Can Lumineers be removed?</span>
              </a>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-10">
              <div className="flex-1">
                ...
                <ul className="font-tinos mt-3 list-disc px-3">
                  ...
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      American Academy of Cosmetic Dentistry (AACD). Veneers and
                      Lumineers. 2022
                    </Link>
                  </li>
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      WebMD. Cosmetic Dentistry Guide. 2022
                    </Link>
                  </li>
                </ul>
