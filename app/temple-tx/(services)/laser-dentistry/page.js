  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-[1fr_1fr_1fr] grid-cols-1 md:gap-2 md:mt-[125px] border-y-[10px] border-dark mx-2">
        <div className="bg-[url(/laser-dentistry.jpg)] bg-cover my-10"></div>
          ...
          <div className="bg-dark p-5 mt-10 text-white">
            ...
            <div className="flex flex-col mb-4">
              <a className="text-justify font-tinos mt-3" href="#">
                Q. <span className="underline">Is laser dentistry safe?</span>
              </a>
              <a className="text-justify font-tinos mt-3" href="#">
                Q. <span className="underline">Does laser dentistry hurt?</span>
              </a>
              <a className="text-justify font-tinos mt-3" href="#">
                Q.{" "}
                <span className="underline">
                ...
                <ul className="font-tinos mt-3 list-disc px-3">
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      American Dental Association (ADA). Laser Use in Dentistry.
                      2022
                    </Link>
                  </li>
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      Academy of Laser Dentistry. Home Page. 2022
                    </Link>
                  </li>
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      WebMD. Laser Dentistry Overview. 2022
                    </Link>
                  </li>
                </ul>
