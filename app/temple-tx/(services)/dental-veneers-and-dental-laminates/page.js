  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-[1fr_1fr_1fr] grid-cols-1 md:gap-2  md:mt-[125px]  border-y-[10px] border-dark mx-2">
        <div className="bg-[url(/dental-veneers-and-dental-laminates.webp)] bg-cover my-10"></div>
            ...
            <div className="bg-dark p-5 mt-10 text-white">
              ...
              <div className="flex flex-col mb-4">
                <a className="text-justify font-tinos mt-3" href="#">
                  Q.{" "}
                  <span className="underline">
                    What are some cosmetic dentistry treatment options?
                  </span>
                </a>
                <a className="text-justify font-tinos mt-3" href="#">
                  Q.{" "}
                  <span className="underline">
                    How can cosmetic dentistry restore teeth?
                  </span>
                </a>
                <a className="text-justify font-tinos mt-3" href="#">
                  Q.{" "}
                  <span className="underline">
                    How should you choose the right treatment and cosmetic
                    dentist?
                  </span>
                </a>
              </div>
