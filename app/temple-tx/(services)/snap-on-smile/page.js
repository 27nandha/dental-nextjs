  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-[1fr_1fr_1fr] grid-cols-1 md:gap-2 md:mt-[125px] border-y-[10px] border-dark mx-2">
        <div className="bg-[url(/snap-on-smile.jpg)] bg-cover my-10"></div>
          ...
          <div className="bg-dark p-5 mt-10 text-white">
            ...
            <div className="flex flex-col mb-4">
              ...
              <a className="text-justify font-tinos mt-3" href="#">
                Q.{" "}
                <span className="underline">
                  Is Snap-On Smile comfortable to wear?
                </span>
              </a>
              <a className="text-justify font-tinos mt-3" href="#">
                Q.{" "}
                <span className="underline">
                  Can Snap-On Smile be used for missing teeth?
                </span>
              </a>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-10">
              <div className="flex-1">
                ...
                <ul className="font-tinos mt-3 list-disc px-3">
                  ...
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      American Academy of Cosmetic Dentistry (AACD). Snap-On
                      Smile Overview. 2022
                    </Link>
                  </li>
                  <li className="mt-2">
                    <Link href="#" className="hover:underline">
                      WebMD. Guide to Cosmetic Dental Procedures. 2022
                    </Link>
                  </li>
                </ul>
