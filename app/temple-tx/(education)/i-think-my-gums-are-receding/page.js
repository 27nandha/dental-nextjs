  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-[1fr_1fr_1fr] grid-cols-1 md:gap-2  md:mt-[125px]  border-y-[10px] border-dark mx-2">
        <div className="bg-[url(/i-think-my-gums-are-receding.webp)] bg-cover my-10"></div>
          ...
          <div className="mt-10" id="what-to-do-about-receding-gums">
            ...
            <div className="bg-dark p-5 mt-10 text-white">
              ...
              <div className="flex flex-col mb-4">
                ...
                <a
                  className="text-justify font-tinos mt-3"
                  href="#oral-health-routine"
                >
                  Q.{" "}
                  <span className="underline">
                    What should be included in an at home oral health routine?
                  </span>
                </a>
              </div>
            </div>
