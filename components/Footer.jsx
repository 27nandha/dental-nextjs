    ...
    <>
        <div className='grid md:grid-cols-2 grid-cols-1 gap-1 my-20'>
            ...
            <div className='flex md:justify-start  justify-center items-center'>
                <div className='w-[80%]'>
                    <h2 className='uppercase text-xl font-cinzel text-center md:text-start mt-5 md:mt-0'><span className='text-2xl'>a</span>bout</h2>
                    ...
                    <div className='grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-3 mt-5'>
                        <div>
                            <h2 className='uppercase text-xl font-cinzel text-center md:text-start'><span className='text-2xl'>O</span>ffice</h2>
                        ...
                        <div>
                            <h2 className='uppercase text-xl font-cinzel text-center md:text-start'><span className='text-2xl'>C</span>ontact</h2>
