...
export const services = [
  ...
  {
    name: "Dental Crowns and Dental Bridges",
    link: "dental-crowns-and-dental-bridges",
  },
  { name: "Dental Implants", link: "dental-implants" },
  {
    name: "Dental Veneers and Dental Laminates",
    link: "dental-veneers-and-dental-laminates",
  },
  {
    name: "Dentures and Partial Dentures",
    link: "dentures-and-partial-dentures",
  },
  { name: "Emergency Dentist", link: "emergency-dentist" },
  { name: "Full Mouth Reconstruction", link: "full-mouth-reconstruction" },
  { name: "Invisalign", link: "invisalign" },
  { name: "Kid Friendly Dentist", link: "kid-friendly-dentist" },
  { name: "Root Canal Treatment", link: "root-canal-treatment" },
